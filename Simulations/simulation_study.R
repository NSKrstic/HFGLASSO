...
source("Simulations/simulate_data.R")
...
save(HFGL_CV_Model_Results, file=paste(Model_Results_Loc, "HFGL_CV_Seed_", Seed, "_Model_Results_SNR_", SNR, "_TBA_Comps_", Weight_Scheme, ".Rdata", sep=""))
