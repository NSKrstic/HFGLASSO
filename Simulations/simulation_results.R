...
#Can generate Figure 3 by setting Scenario A, SNR=1 and only running for Seeds=100 (only the first seed)
##pdf("Figure_3.pdf", width=12, height=8)
...
for(i in 1:length(Seeds)){
  ...
  load(paste(Model_Results_Loc, "HFGL_CV_Seed_", Seed, "_Model_Results_SNR_", SNR, "_TBA_Comps_", Weight_Scheme, ".Rdata", sep=""))
